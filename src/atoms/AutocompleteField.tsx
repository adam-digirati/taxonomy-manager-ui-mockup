    ...
    >
      {({
        ...
        const { onBlur, onChange, onFocus, ...inputProps } = getInputProps({
          ...
          placeholder: 'Select multiple concepts',
        });
        return (
...
const AutocompleteField: React.SFC<AutocompleteFieldProps> = ({ value, name, ...props }) => {
...
type MultiValueAutocompleteFieldProps = {
  value:string[];
  handleChange?: React.EventHandler<HtmlEvent>;
  name:string;
  label?:string;
...
export const MultiValueAutocompleteField: React.SFC<MultiValueAutocompleteFieldProps> = ({ value, name, ...props }) => {
  const classes = useStyles();
  return (
